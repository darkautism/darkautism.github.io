...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke0_mut__h2d5c40494349aaa4: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h373808319e75135c: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h176f0c3f41008c57: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h1aa27825b365cd8f: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__hb707b52643e3d60d: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h4a0f169e7e472ca4: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he5b53b036cdda1f0: (a: number, b: number, c: number) => void;
