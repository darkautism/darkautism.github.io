...
export function wasm_bindgen__convert__closures__invoke1_mut__h07774964d354d3b7(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__hbc686af74b987461(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hd07089ed30941029(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h3959f0dde01edf5d(a: number, b: number): void;
